...
class ArticleProfile extends Component {
  ...
  async componentWillMount() {
    ...
    const { data } = await axios.get(`${url}/api/posts/fetchPosts/${this.props.currentViewArticle.id}`, this.config);
  ...
  async onAddHandler () {
    ...
    const d = await axios.get(`${url}/api/posts/fetchPosts/${this.props.currentViewArticle.id}`, this.config);
